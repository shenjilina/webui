...
const statusConfig: Record<VectorTaskStatusType, { label: string; variant: 'default' | 'secondary' | 'success' | 'destructive' | 'info'; icon?: boolean }> = {
...
export function TaskStatusBadge({ status }: TaskStatusBadgeProps) {
  ...
  return (
    <Badge variant={config.variant as 'default' | 'secondary' | 'success' | 'destructive' | 'info'} className="gap-1">
